# Secure-your-word-documents-in-dotnet
This repo contains source code from the webinar 'Secure Your Word Documents in .NET: Encryption, Protection, and Selective Editing Made Easy' using Syncfusion DocIO. It demonstrates password encryption, document protection and selective editable regions.

## Key Features
- Protect Word documents with a password.
- Apply document-level protection options (read-only, form-only, comments-only, etc.).
- Remove protection (unprotect) when a valid password is provided.
...
*   **Documentation:** [Syncfusion&reg; Word library](https://help.syncfusion.com/document-processing/word/word-library/overview)
